      ...
      <div className="container mt-5">
        <form>
          ...
          <small class="form-text text-muted thumbnailMessage mb-3">
            This is the first thing the readers will notice.
          </small>
          {/* <image src= alt="Thumbnail-photo" /> */}
          <small class="form-text text-muted thumbnailMessage mb-3">
            Tip to Write a good description: Always begin with a short intro,
            which can be more than 3-4 lines without text styling.
          </small>
          ...
          <button className="publish-btn mt-3" onClick={testdata}>
            Publish
          </button>
        </form>
      </div>
